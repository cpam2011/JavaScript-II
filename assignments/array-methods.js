...
runnersLargeSizeShirt = runners.filter (function (runners) {
...
ticketPriceTotal = runners.reduce(function (dono, runners){
  return dono + runners.donation;
}, 0);
...
// Problem 1
let companyEmail = [];
runners.forEach(function(info){
    companyEmail.push(`Company: ${info.company_name}, email: ${info.email}`)
})
console.log(companyEmail);

// Problem 2
let xtraLarge = runners.filter (function (runners) {
  return runners.shirt_size === "XL";
})
console.log(xtraLarge);

let small = runners.filter (function (runners) {
  return runners.shirt_size === "S";
})
console.log(small);

// Problem 3
let mediumDonos = runners.filter(function (medium) {
  return medium.shirt_size === "M";
})
.reduce(function (donoM, mediumShirt){
  return donoM + mediumShirt.donation;
}, 0)

console.log(mediumDonos);